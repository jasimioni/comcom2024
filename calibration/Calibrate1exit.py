...
'''
./Calibrate1exit.py --model alexnet ../trained_models/AlexNet_epoch_16_91.2.pth --savefolder calibrated/AlexNet/
./Calibrate1exit.py --model mobilenet ../trained_models/MobileNetV2_epoch_17_90.9.pth --savefolder calibrated/MobileNet
